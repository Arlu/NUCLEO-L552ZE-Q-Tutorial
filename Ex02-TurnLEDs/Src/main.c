...
#define RCC_AHB2ENR ((0x40021000) + (0x4C))

#define GPIOA_EN 0
#define GPIOB_EN 1
#define GPIOC_EN 2

// GPIOA base addr 0x4202 0400
#define GPIOA_base_addr  (0x42020000)
// GPIOA mode register 0x00
#define GPIOA_MODER (GPIOA_base_addr + (0x0))
// GPIOB base addr 0x4202 0400
#define GPIOB_base_addr  (0x42020400)
// GPIOB mode register 0x00
#define GPIOB_MODER (GPIOB_base_addr + (0x0))
// GPIOC base addr 0x4202 0400
#define GPIOC_base_addr  (0x42020800)
// GPIOC mode register 0x00
#define GPIOC_MODER (GPIOC_base_addr + (0x0))

//GPIO A data output register offset GPIO port output data register (GPIOx_ODR) 0x14
#define GPIOA_ODR (GPIOA_base_addr + (0x14))
//GPIO B data output register offset GPIO port output data register (GPIOx_ODR) 0x14
#define GPIOB_ODR (GPIOB_base_addr + (0x14))
//GPIO C data output register offset GPIO port output data register (GPIOx_ODR) 0x14
#define GPIOC_ODR (GPIOC_base_addr + (0x14))
