...
#define NVIC_ISER3          (*(volatile uint32_t *)(NVIC_BASE + 0x00CUL))
...
#define NVIC_ICER3          (*(volatile uint32_t *)(NVIC_BASE + 0x08CUL))
#define NVIC_ISPR0          (*(volatile uint32_t *)(NVIC_BASE + 0x100UL))
#define NVIC_ISPR1          (*(volatile uint32_t *)(NVIC_BASE + 0x104UL))
#define NVIC_ISPR2          (*(volatile uint32_t *)(NVIC_BASE + 0x108UL))
#define NVIC_ISPR3          (*(volatile uint32_t *)(NVIC_BASE + 0x10CUL))
#define NVIC_ICPR0          (*(volatile uint32_t *)(NVIC_BASE + 0x180UL))
#define NVIC_ICPR1          (*(volatile uint32_t *)(NVIC_BASE + 0x184UL))
#define NVIC_ICPR2          (*(volatile uint32_t *)(NVIC_BASE + 0x188UL))
#define NVIC_ICPR3          (*(volatile uint32_t *)(NVIC_BASE + 0x18CUL))
#define NVIC_IABR0          (*(volatile uint32_t *)(NVIC_BASE + 0x200UL))
#define NVIC_IABR1          (*(volatile uint32_t *)(NVIC_BASE + 0x204UL))
#define NVIC_IABR2          (*(volatile uint32_t *)(NVIC_BASE + 0x208UL))
#define NVIC_IABR3          (*(volatile uint32_t *)(NVIC_BASE + 0x20CUL))
#define NVIC_IPR0           (*(volatile uint32_t *)(NVIC_BASE + 0x300UL))
#define NVIC_IPR1           (*(volatile uint32_t *)(NVIC_BASE + 0x304UL))
#define NVIC_IPR2           (*(volatile uint32_t *)(NVIC_BASE + 0x308UL))
#define NVIC_IPR3           (*(volatile uint32_t *)(NVIC_BASE + 0x30CUL))
...
/* SRAM Size (256KB for STM32L552ZET6QU) */
#define SRAM_SIZE           0x40000UL
...
#define SCB_SHCSR_SECFAULTENA_Pos     19
#define SCB_SHCSR_MEMFAULTENA_Msk     (1UL << SCB_SHCSR_MEMFAULTENA_Pos)
#define SCB_SHCSR_BUSFAULTENA_Msk     (1UL << SCB_SHCSR_BUSFAULTENA_Pos)
#define SCB_SHCSR_USGFAULTENA_Msk     (1UL << SCB_SHCSR_USGFAULTENA_Pos)
#define SCB_SHCSR_SECFAULTENA_Msk     (1UL << SCB_SHCSR_SECFAULTENA_Pos)
...
/* NVIC IRQ numbers for STM32L552ZET6QU */
typedef enum {
...
static inline void NVIC_DisableIRQ(IRQn_Type IRQn) {
	...
	switch (ind) {
		...
		case 1:
			...
			break;
		case 2:
			NVIC_ICER2 |= (1UL << ((uint32_t)IRQn & 0x1FUL));
			break;
		case 3:
			NVIC_ICER3 |= (1UL << ((uint32_t)IRQn & 0x1FUL));
			break;
		default:
			break;
    }
